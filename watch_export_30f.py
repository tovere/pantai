...
# 回测注解(30f口径, 40天小样本仅方向性)。总胜率 / 启动几率 / 启动后胜率。
BACKTEST_NOTE = {
    "resonance_stock": "40天14笔·总50%·启动29%·启动后75%",
    "resonance_etf":   "40天·样本极少·观察",
    "s5_stock_strict": "343笔·总38%·启动22%·启动后82%",
    "s5_stock_loose":  "1064笔·总40%·启动24%·启动后84%",
    "s5_etf_strict":   "167笔·总31%·启动7%·启动后50%",
    "s5_etf_loose":    "40天·小样本·参考",
    "s6_stock":        "92笔·总45%·启动31%·启动后96%",
    "s6_etf":          "40天·样本极少·观察",
    "s7_stock":        "37笔·总35%·启动19%·启动后~55%",
    "s7_etf":          "40天·样本极少·观察",
}
